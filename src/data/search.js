...
export const staticSearchPages = [
  ...
  { path: "/contact/", changefreq: "monthly", priority: "0.3", indexable: true },
  { path: "/privacy-policy/", changefreq: "monthly", priority: "0.3", indexable: true },
  { path: "/terms/", changefreq: "monthly", priority: "0.3", indexable: true }
];
